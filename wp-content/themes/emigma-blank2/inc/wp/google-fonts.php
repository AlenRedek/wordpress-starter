<?php
if (!function_exists('roman_google_fonts')){
function roman_google_fonts(){	
...
if (!function_exists('roman_fallback_font_array')){
function roman_fallback_font_array(){
    
    $fallback_font_arr = array();
    ...
    foreach ($fallback_fonts as $font) {
        $fallback_font_arr[$font] = $font;
    }
    return $fallback_font_arr;
    
}
}

if (!function_exists('roman_font_array')){
function roman_font_array(){
	return array_merge (roman_fallback_font_array(),roman_google_fonts());
}
}
include('fonts.php');