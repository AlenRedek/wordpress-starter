...
class emigma_language_widget extends WP_Widget {

    public function __construct(){
        $widget_details = array(
            'classname' => 'emigma_language_widget',
            'description' => __('Creates a language switcher.', 'emigma')
        );

        parent::__construct( 'emigma_language_widget', __('AR Language Switcher', 'emigma'), $widget_details );
    }
