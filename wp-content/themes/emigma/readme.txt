...
## Changelog
            ...
            - ** 0.4.0 Apr. 29th 2016 **
                   ...
                   - Updating Gulpfile - now "gulp copy-assets" command copies all files from dependency folders into mid-layer folder called "/assets/src"
...
- The `/assets/css/theme.css` and it´s minified little brother `/assets/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/assets/sass/theme.scss`:
