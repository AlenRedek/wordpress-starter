...
if( ! function_exists('theme_register_required_plugins') ){
    ...
    function theme_register_required_plugins() {
         ...
         */
        $config = array(
            'domain'       		=> 'understrap',         	// Text domain - likely want to be the same as your theme.
            ...
            'strings'      		=> array(
                ...
                'installing'                       			=> __( 'Installing Plugin: %s', 'understrap' ), // %1$s = plugin name
                ...
                'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'understrap' ), // %1$s = dashboard link
