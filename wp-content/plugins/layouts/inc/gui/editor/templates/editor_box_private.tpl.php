    ...
    <div class="toolbar_for_private_layout">
        ...
        <div class="editor-toolbar editor-toolbar-private js-editor-toolbar">
            <div class="save-button-wrap">
                ...
                <button name="save_private_layout" class="button button-primary button-large" id="js-private-layout-done-button"><?php _e('Update','ddl-layouts'); ?></button>
            </div>
            ...
            <div class="pl_title"><?php _e('Editing content for:', 'dd-layouts');?> <?php echo $post_title;?></div>
        </div>
    </div>
