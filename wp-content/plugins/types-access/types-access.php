...
if ( ! class_exists('Toolset_Constants') ) {
	require TACCESS_PLUGIN_PATH . '/vendor/toolset/toolset-common/inc/controller/constants.php';
}
global $access_constants;
$access_constants = new Toolset_Constants();
